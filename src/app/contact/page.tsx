...
export const metadata: Metadata = {
  title: 'Contact Us | TwiinZ Beard',
};

export default function ContactPage() {
  return (
    <section className="max-w-3xl mx-auto px-6 py-16 space-y-6 text-sm leading-relaxed">
      <h1 className="text-3xl font-semibold">Contact TwiinZ Beard</h1>
      <p>
      ...
      <div className="space-y-2">
        ...
        <p>
          <strong>Mailing:</strong> TwiinZ Beard Balm &amp; Essentials, 123 Artisan Row, Nashville, TN 37201
        </p>
      </div>
      <p>
